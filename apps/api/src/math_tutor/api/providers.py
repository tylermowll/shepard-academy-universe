...
def probe_error(error: ProviderError) -> ProviderError:
    details = {
        ...
        "cloud_disabled": "Cloud calls are disabled. Review and save the app's data policy before testing a cloud connection.",
        "audience_blocked": "This connection's age policy does not match the app audience. Review both settings before testing.",
